...
var endGame = function () {
    ...
    // instead of "if (highScore === null) {highScore = 0;}" we use shorthand
...
var playerInfo = {
    ...
    refillHealth: function () {
        if (this.name === "Daxbot") {
            window.alert("Ah, the legendary Daxbot! Refilling health by 100, on the house!");
            this.health += 100;
        } else {
            if (this.money >= 7) {
    ...
    upgradeAttack: function () {
        if (this.name === "Daxbot") {
            window.alert("Ah, the legendary Daxbot! Upgrading attack by 50, on the house!");
            this.attack += 50;
        } else {
            if (this.money >= 7) {
